...
The aim of building the robot was to develop a low-cost modular autonomous bot that can be used for various applications by switching the attachment on the bot, UV lamp is used in the present case for sterilization of the hospital ward and ICUs. The autonomous functionality was kept limited to keep the components and cost to a minimum. ESP32 is selected as the main controller because of its cost, speed, and dual-core architecture. In addition, it features an inbuilt wifi module for running the webserver. [ESP-IDF framework](https://github.com/espressif/esp-idf) is used as the main software for developing the embedded firmware. 
...
<div align="center">  
     <a href="https://www.youtube.com/watch?v=6YCGod-HsaE">
     <img 
      src="https://img.youtube.com/vi/6YCGod-HsaE/0.jpg" 
      alt="V1" 
      style="width:100%;">
      </a>  
      <a href="https://www.youtube.com/watch?v=vrKzI4iPh6s">
     <img 
      src="https://img.youtube.com/vi/vrKzI4iPh6s/0.jpg" 
      alt="V1" 
      style="width:100%;">
      </a>
      </div>   
...
#### Ground test forward [Version 1](https://github.com/tech-igloo/Semi-autonomous-UV-sterilization-bot/) and [Version2](https://github.com/tech-igloo/UV-sterilization-bot-version2)  
      
<div align="center">
      <a href="https://www.youtube.com/watch?v=8vxNBiGw6P0">
     <img 
      src="https://img.youtube.com/vi/8vxNBiGw6P0/0.jpg" 
      alt="V1" 
      style="width:100%;">
      </a>    
      <a href="https://www.youtube.com/watch?v=YlV8ebhE-zM">
     <img 
      src="https://img.youtube.com/vi/YlV8ebhE-zM/0.jpg" 
      alt="V1" 
      style="width:100%;">
      </a>     
      </div>   
...
#### Ground test rotation [Version 1](https://github.com/tech-igloo/Semi-autonomous-UV-sterilization-bot/) and [Version2](https://github.com/tech-igloo/UV-sterilization-bot-version2)      
      
<div align="center">  
      <a href="https://www.youtube.com/watch?v=fDLGWJ3a7CQ">
     <img 
      src="https://img.youtube.com/vi/fDLGWJ3a7CQ/0.jpg" 
      alt="V1" 
      style="width:100%;">
      </a>    
      <a href="https://www.youtube.com/watch?v=jSq6IaW4F_g">
     <img 
      src="https://img.youtube.com/vi/jSq6IaW4F_g/0.jpg" 
      alt="V1" 
      style="width:100%;">
      </a>    
      </div>
